    ...
    <section id='about'>
      ...
      <div className='container about__container'>
        ...
        <div className='about__content'>
          ...
          <p>
          Experienced Front-End Web Developer with 7+ years in creating high-performance, 
          user-focused websites and applications. Specializes in React.js, Vue.js, JavaScript, 
          HTML5, and CSS3, with a track record of leading projects from concept through deployment. 
          Expertise in optimizing performance, ensuring accessibility, and improving user experience 
          with measurable results across multiple platforms.
          </p>
